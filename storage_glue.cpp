...
//  TODO: Implement furi_hal_rtc_get_timestamp
...
static StorageFile* storage_get_file(const FZFile* file, StorageData* storage) {
...
bool storage_has_file(const FZFile* file, StorageData* storage) {
...
void storage_set_storage_file_data(const FZFile* file, void* file_data, StorageData* storage) {
...
void* storage_get_storage_file_data(const FZFile* file, StorageData* storage) {
    StorageFile* storage_file_ref = storage_get_file(file, storage);
    // furi_check(storage_file_ref != NULL);
    return storage_file_ref->file_data;
}

void storage_push_storage_file(FZFile* file, FuriString* path, StorageData* storage) {
...
bool storage_pop_storage_file(FZFile* file, StorageData* storage) {
    StorageFileList_it_t it;
    bool result = false;
