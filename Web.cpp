...
#ifdef HAS_SCREEN
  display_obj.display.print(text_table3[0]);  
#endif
...
#ifdef HAS_SCREEN
  display_obj.display.print(text_table1[2]);
  display_obj.display.println(ssid);
  display_obj.display.print(text_table3[1]);
  display_obj.display.print(WiFi.softAPIP());
...
#ifdef HAS_SCREEN
      display_obj.display.setTextColor(WHITE);
      display_obj.display.print(text_table3[2]);
      display_obj.display.print(upload.filename.c_str());
      display_obj.display.print("\n");
#endif
...
#ifdef HAS_SCREEN
      display_obj.display.setTextColor(WHITE);
      display_obj.display.fillRect(0, 164, 240, 8, SSD1306_BLACK);
      display_obj.display.setCursor(0, 164);
      display_obj.display.print(text_table3[3]);
      display_obj.display.print(upload.totalSize);
      display_obj.display.print("\n");
#endif
...
#ifdef HAS_SCREEN
        display_obj.display.setTextColor(WHITE);
        display_obj.display.print(text_table3[4]);
        display_obj.display.print(upload.totalSize);
        display_obj.display.print(text_table2[3]);
#endif
...
#ifdef HAS_SCREEN
  display_obj.display.setTextColor(WHITE);
  display_obj.display.println(text_table3[5]);
#endif
