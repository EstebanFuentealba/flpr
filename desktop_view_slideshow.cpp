...
static void desktop_view_slideshow_draw(Canvas* canvas, void* model) {
    DesktopSlideshowViewModel* m = (DesktopSlideshowViewModel*)model;
...
static bool desktop_view_slideshow_input(InputEvent* event, void* context) {
    // furi_assert(event);
    DesktopSlideshowView* instance = (DesktopSlideshowView*)context;

    DesktopSlideshowViewModel* model = (DesktopSlideshowViewModel*)view_get_model(instance->view);
...
DesktopSlideshowView* desktop_view_slideshow_alloc() {
    DesktopSlideshowView* instance = (DesktopSlideshowView*)malloc(sizeof(DesktopSlideshowView));
