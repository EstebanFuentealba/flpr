...
static bool desktop_view_pin_input_input(InputEvent* event, void* context) {
    ...
    DesktopViewPinInput* pin_input = (DesktopViewPinInput*)context;
    DesktopViewPinInputModel* model = (DesktopViewPinInputModel*)view_get_model(pin_input->view);
...
static void desktop_view_pin_input_draw(Canvas* canvas, void* context) {
    ...
    DesktopViewPinInputModel* model = (DesktopViewPinInputModel*)context;
...
void desktop_view_pin_input_timer_callback(TimerHandle_t timer) {
    DesktopViewPinInput* pin_input = (DesktopViewPinInput*)pvTimerGetTimerID(timer);
...
DesktopViewPinInput* desktop_view_pin_input_alloc(void) {
    DesktopViewPinInput* pin_input = (DesktopViewPinInput*)malloc(sizeof(DesktopViewPinInput));
