...
ViewPort* view_port_alloc() {
    ViewPort* view_port = (ViewPort*)malloc(sizeof(ViewPort));
...
void view_port_update(ViewPort* view_port) {
    //furi_assert(view_port);
    Serial.println("[view_port] check gui && is_enabled");
    if (view_port->gui && view_port->is_enabled){
        Serial.println("[view_port] try gui_update");
        gui_update(view_port->gui);
         Serial.println("[view_port] gui_update");
    }
