...
static void dialogs_app_message_back_callback(void* context) {
    // furi_assert(context);
    DialogsAppMessageContext* message_context = (DialogsAppMessageContext*)context;
...
DialogMessageButton dialogs_app_process_module_message(const DialogsAppMessageDataDialog* data) {
    ...
    DialogsAppMessageContext* message_context = (DialogsAppMessageContext*)malloc(sizeof(DialogsAppMessageContext));
...
DialogMessage* dialog_message_alloc() {
    DialogMessage* message = (DialogMessage*)malloc(sizeof(DialogMessage));
    return message;
}
