...
FlipperApplication*
    ...
    FlipperApplication* app = (FlipperApplication*)malloc(sizeof(FlipperApplication));
...
static bool flipper_application_process_manifest_section(
    ...
    size_t size,
    void* context) {
    FlipperApplicationManifest* manifest = (FlipperApplicationManifest*)context;
...
bool flipper_application_load_name_and_icon(
    ...
    FlipperApplication* app = flipper_application_alloc(storage);
    ...
    if(preload_res == FlipperApplicationPreloadStatusSuccess) {
        ...
        furi_string_set_str(item_name, manifest->name);
        load_success = true;
    } else {
