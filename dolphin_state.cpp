...
DolphinState* dolphin_state_alloc() {
    return (DolphinState*)malloc(sizeof(DolphinState));
}
...
bool dolphin_state_load(DolphinState* dolphin_state) {
    Serial.println("[dolphin] try dolphin_state_load saved_struct_load");
    bool success = saved_struct_load(
        ...
        DOLPHIN_STATE_HEADER_MAGIC,
        DOLPHIN_STATE_HEADER_VERSION);
    Serial.println("[dolphin] dolphin_state_load saved_struct_load");
    if(success) {
