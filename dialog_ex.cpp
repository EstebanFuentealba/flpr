...
static void dialog_ex_view_draw_callback(Canvas* canvas, void* _model) {
    DialogExModel* model = (DialogExModel*)_model;
...
DialogEx* dialog_ex_alloc() {
    DialogEx* dialog_ex = (DialogEx*)malloc(sizeof(DialogEx));
...
void dialog_ex_reset(DialogEx* dialog_ex) {
    ...
    IconElement clean_icon_el = {.x = 0, .y = 0, .icon = NULL};
