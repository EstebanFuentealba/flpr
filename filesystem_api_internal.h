...
//     bool (*const close)(void* context, FZFile* file);
//     uint16_t (*read)(void* context, FZFile* file, void* buff, uint16_t bytes_to_read);
//     uint16_t (*write)(void* context, FZFile* file, const void* buff, uint16_t bytes_to_write);
//     bool (*const seek)(void* context, FZFile* file, uint32_t offset, bool from_start);
//     uint64_t (*tell)(void* context, FZFile* file);
//     bool (*const truncate)(void* context, FZFile* file);
//     uint64_t (*size)(void* context, FZFile* file);
//     bool (*const sync)(void* context, FZFile* file);
//     bool (*const eof)(void* context, FZFile* file);
// } FS_File_Api;
 ...
 */
// typedef struct {
//     bool (*const open)(void* context, FZFile* file, const char* path);
//     bool (*const close)(void* context, FZFile* file);
//     bool (*const read)(
//         void* context,
//         FZFile* file,
...
//     bool (*const rewind)(void* context, FZFile* file);
// } FS_Dir_Api;
