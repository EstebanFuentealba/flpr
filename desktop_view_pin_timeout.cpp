...
static void desktop_view_pin_timeout_timer_callback(TimerHandle_t timer) {
    DesktopViewPinTimeout* instance = (DesktopViewPinTimeout*)pvTimerGetTimerID(timer);
    bool stop = false;

    DesktopViewPinTimeoutModel* model = (DesktopViewPinTimeoutModel*)view_get_model(instance->view);
...
static void desktop_view_pin_timeout_draw(Canvas* canvas, void* _model) {
    ...
    DesktopViewPinTimeoutModel* model = (DesktopViewPinTimeoutModel*)_model;
...
DesktopViewPinTimeout* desktop_view_pin_timeout_alloc(void) {
    DesktopViewPinTimeout* instance = (DesktopViewPinTimeout*)malloc(sizeof(DesktopViewPinTimeout));
