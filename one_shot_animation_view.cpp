...
static void one_shot_view_update_timer_callback(TimerHandle_t xTimer) {
    OneShotView* view = (OneShotView*)(void*)pvTimerGetTimerID(xTimer);

    OneShotViewModel* model = (OneShotViewModel*)view_get_model(view->view);
...
static void one_shot_view_draw(Canvas* canvas, void* model_) {
    ...
    OneShotViewModel* model =(OneShotViewModel*) model_;
...
static bool one_shot_view_input(InputEvent* event, void* context) {
    ...
    OneShotView* view = (OneShotView*) context;
    bool consumed = false;
...
OneShotView* one_shot_view_alloc(void) {
    OneShotView* view = (OneShotView*)malloc(sizeof(OneShotView));
