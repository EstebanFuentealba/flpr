...
static void submenu_view_draw_callback(Canvas* canvas, void* _model) {
    SubmenuModel* model = (SubmenuModel*)_model;
...
static bool submenu_view_input_callback(InputEvent* event, void* context) {
    Submenu* submenu = (Submenu*) context;
    // furi_assert(submenu);
    bool consumed = false;
...
Submenu* submenu_alloc() {
    Submenu* submenu = (Submenu*)malloc(sizeof(Submenu));
    ...
    SubmenuModel* model = (SubmenuModel*)view_get_model(submenu->view);
